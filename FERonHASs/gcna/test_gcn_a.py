...
from gcna.datasets import build_dataset
from gcna.confidence import confidence_to_peaks
...
def test_gcn_a(model, cfg, logger):
    for k, v in cfg.model['kwargs'].items():
        setattr(cfg.test_data, k, v)
    dataset = build_dataset(cfg.model['type'], cfg.test_data)

    folder = '{}_gcna_k_{}_th_{}'.format(cfg.test_name, cfg.knn, cfg.th_sim)
    ...
    if cfg.use_gcn_feat:
        # gcn_feat is saved to disk for GCN-S
        ...
        # use top embedding of GCNA to rebuild the kNN graph
